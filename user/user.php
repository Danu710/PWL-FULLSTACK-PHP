                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate method="POST"
                                action="user/proses_tambah_user.php">
                                <div class="row">
                                    <div class="col-lg-6">
                ...
                <div class="modal fade" id="modalview<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="user/proses_input_user.php"
                                    method="POST">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                ...
                <div class="modal fade" id="modaledit<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="user/proses_edit_user.php">
                ...
                <div class="modal fade" id="modaldelet<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-md modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="user/proses_hapus_user.php">
                                    <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                    <div class="col-lg-12">
                                        <?php
                ...
                <div class="modal fade" id="modalresetpassword<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-md modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate method="POST"
                                    action="user/proses_reset_password.php">
                                    <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_simsditp']) {
