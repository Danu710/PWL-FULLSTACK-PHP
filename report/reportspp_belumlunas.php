...
$sql = "SELECT * FROM spp where status='Belum Lunas' ORDER BY nama_siswa ASC";
...
<html>
<head>
    <title>Report Pembayaran Siswa Belum Lunas</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h2>Report Pembayaran Siswa Belum Lunas</h2>
        <?php
