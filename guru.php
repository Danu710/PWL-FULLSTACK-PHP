                ...
                <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate method="POST" action="proses/proses_tambah_guru.php">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="nama" name="nama_guru" required>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="input_guru_validate" value="12345">Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modaldelet<?php echo $row['nama_guru'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate method="POST" action="proses/proses_hapus_guru.php">
                                        <input type="hidden" value="<?php echo $row['nama_guru'] ?>" name="nama_guru">
                                        Apakah Anda Ingin Menghapus Data Guru yang bernama <b><?php echo $row['nama_guru'] ?></b> ?
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                            <button type="submit" class="btn btn-danger hapus" name="hapus_guru_validate" value="12345">Hapus</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr style="text-align:center">
                                    ...
                                    <td class="d-flex" style="justify-content: center">
                                        <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#modaledit<?php echo $row['nama_guru'] ?>"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-danger btn-sm me-1" data-bs-toggle="modal" data-bs-target="#modaldelet<?php echo $row['nama_guru'] ?>"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                                <?php
                            }
